...
public class AccessControlAspectsUser {
	...
	@Around("execution(* pravin.rv.quizzz.repository.UserRepository.save(..)) && args(user)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.UserRepository.find(Long)) && args(id)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.UserRepository.findAll())")
	...
	@Around("execution(* pravin.rv.quizzz.repository.UserRepository.delete(..)) && args(user)")
