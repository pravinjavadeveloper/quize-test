...
public class AccessControlAspectsQuiz {
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuizRepository.save(..)) && args(quiz,..)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuizRepository.find(Long)) && args(id)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuizRepository.findAll())")
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuizRepository.delete(..)) && args(quiz)")
