...
import pravin.rv.quizzz.service.accesscontrol.AccessControlService;
...
public class AccessControlAspectsQuestion {
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuestionRepository.save(..)) && args(question)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuestionRepository.find(Long)) && args(id)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuestionRepository.findAll())")
	...
	@Around("execution(* pravin.rv.quizzz.repository.QuestionRepository.delete(..)) && args(question)")
