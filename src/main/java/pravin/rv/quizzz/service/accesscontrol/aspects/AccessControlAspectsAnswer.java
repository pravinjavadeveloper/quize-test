...
public class AccessControlAspectsAnswer {
	...
	@Around("execution(* pravin.rv.quizzz.repository.AnswerRepository.save(..)) && args(answer)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.AnswerRepository.find(Long)) && args(id)")
	...
	@Around("execution(* pravin.rv.quizzz.repository.AnswerRepository.findAll())")
	...
	@Around("execution(* pravin.rv.quizzz.repository.AnswerRepository.delete(..)) && args(answer)")
